...
.left-bottom-logo {
 ...
 <div class="card-top">
    <div class="card-img">
        ...
        <img alt="logo"  src="../img/logo-pink.png"  class="img-responsive   inner-logo">
 </div>
  ...
  <div class="row">
    <div class="col-xs-6">
           ...
           <div class="card-container-left">
            ...
            <img alt="logo"  src="../img/logo-pink-01.png"  class="img-responsive   left-bottom-logo">
        </div>   
    ...
    <div class="row">
        <div class="col-xs-12 card-container-right">
