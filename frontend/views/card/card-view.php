...
.wrap > .container {
  ...
  <img alt="logo" src="../img/logo-blank.png"  class="img-responsive logo" >
  <div class="row">
    <div class="col-xs-6">
        <div class="card-img">
        <?php if(!empty($model->photo)){?>        
          ...
          <?php }?>
            <a class="fancybox"  title="扫描二维码访问<?=$model->name?>的名片"  data-fancybox-group="gallery"  href="<?= yii::getAlias('@photo')?>/qrcode/<?=$model->user_guid?>.png">
  ...
  <img alt="logo"  src="../img/logo-circle.png"  class="img-responsive   bottom-logo">
  
<!--  <audio id="bgm" src="../music/xunyicao1.m4a" autoplay="autoplay" loop="" style="display: none; width: 0; height: 0;"></audio>-->
