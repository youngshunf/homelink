...
<div class="panel-white">
    ...
    <p>
        ...
        <?= Html::a('导出EXCEL', ['export-result', 'id' => $model->qid], [
      ...
      <?= GridView::widget([
        ...
        'columns' => [
    		...
    		['attribute'=>'被评价人','value'=>function ($model){
    		    return $model->evalUser->real_name;
    		}],
            ...
            [	'class' => 'yii\grid\ActionColumn',
            	...
            	'template'=>'{eval-view}{eval-delete}',
	             'buttons'=>[
	                 ...
	                 return  Html::a('<span class="glyphicon glyphicon-eye-open"></span>', $url, ['title' => '查看详情'] );
	                 },
					'eval-delete'=>function ($url,$model,$key){
					return  Html::a('<span class="glyphicon glyphicon-trash"></span>', $url, ['title' => '删除选项', 'data-confirm'=>'是否确定删除本条评价记录吗？'] );
					},					
				]
           	],
        ],
